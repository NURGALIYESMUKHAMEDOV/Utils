define([
    ...
    "esbd/editor/ObjectListSearchPane",
    ...
    return declare("esbd.editor.ObjectList", [
        BorderContainer
    ], {
        ...
        postCreate: function() {
            ...
            var searchPane = new ObjectListSearchPane({
                ...
                onSearchCompleted: dojo.hitch(this, function(resultSet){
                    ...
                    resultSet.toolbarDef = "ESBD_ObjectListMenuType" ;
        ...
        _createContentList: function() {
            ...
            resultSet.repository = this.repository ;
