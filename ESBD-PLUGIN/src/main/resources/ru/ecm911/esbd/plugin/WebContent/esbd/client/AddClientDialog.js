...
define([
    ...
    "dojo/text!./templates/AddClientDialog.html"
], function(
    declare,
    lang,
    has,
    ...
    template)
{
	...
	return declare("esbd.client.AddClientDialog", [
		BaseDialog
	], {
        ...
        _createRendering: function() {
            ...
            var renderAttributes = dojo.hitch(this, function() {
                ...
                this.setTitle(this.config.addEntryTemplate.name);

                this.setIntroText(this.config.addEntryTemplate.description);
