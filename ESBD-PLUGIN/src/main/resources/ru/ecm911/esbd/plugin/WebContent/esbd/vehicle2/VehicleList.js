...
define([
    ...
    "esbd/vehicle2/VehicleListSearchPane",
    "esbd/vehicle2/AddVehicleDialog",
    ...
    return declare("esbd.vehicle2.VehicleList", [
        BorderContainer
    ], {
        ...
        postCreate: function() {
            ...
            var searchPane = new VehicleListSearchPane({
                ...
                onSearchCompleted: dojo.hitch(this, function(resultSet){
                    ...
                    resultSet.toolbarDef = "ESBD_VehicleListMenuType" ;
        ...
        _createContentList: function() {
            ...
            var resultSet = new ResultSet({
                ...
                toolbarDef: "ESBD_VehicleListMenuType",
