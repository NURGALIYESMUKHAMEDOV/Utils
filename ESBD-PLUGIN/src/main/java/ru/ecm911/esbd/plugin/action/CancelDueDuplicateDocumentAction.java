...
public class CancelDueDuplicateDocumentAction extends PluginAction {

    public static String Id = "ESBDCancelDueDuplicateDocumentAction" ;

    @Override
    public String getId() {

        return CancelDueDuplicateDocumentAction.Id;
