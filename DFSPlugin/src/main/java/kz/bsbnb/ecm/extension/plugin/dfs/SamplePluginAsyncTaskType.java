...
public class SamplePluginAsyncTaskType extends PluginAsyncTaskType {
	...
	public String getClassHandlerName(){
		...
		/*try {
			Class.forName("kz.bsbnb.ecm.extension.plugin.dfs.asyncTasks.SampleICNTask");
		}
		catch(Throwable ignore) {
			// ignored
		}*/

		return "kz.bsbnb.ecm.extension.plugin.dfs.asyncTasks.SampleICNTask";
	}
	...
	public String getTaskCreationDialogDijitClass() {
		return "docs/asyncTasks/ICNSampleTaskCreationDialog";
	}
