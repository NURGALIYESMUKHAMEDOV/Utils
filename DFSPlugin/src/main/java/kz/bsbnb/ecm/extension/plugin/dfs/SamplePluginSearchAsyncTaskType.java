...
public class SamplePluginSearchAsyncTaskType extends PluginAsyncTaskType {
	...
	public String getClassHandlerName(){
		return "kz.bsbnb.ecm.extension.plugin.dfs.asyncTasks.SampleSearchICNTask";
	}
	 ...
	 * <p>
	 * Refer to the documentation on {@link 2ecm.widget.taskManager.BaseTaskCreationDialog BaseTaskCreationDialog} for
	 * more information on what is required.
	 * </p>
	 */
	public String getTaskCreationDialogDijitClass() {
		return "docs/asyncTasks/ICNSampleSearchTaskDialog";
	}
	 ...
	 * <p>
	 * Refer to the documentation on {@link 2ecm.widget.taskManager.BaseTaskInformationPane BaseTaskInformationPane} for
	 * more information on what is required.
	 * </p>
	 */
	public String getTaskInformationDijitClass() {
		return "docs/asyncTasks/ICNSampleSearchTaskInformationPane";
	}
