...
public class AssignmentService extends PluginService {

    public static final String Id = "AssignmentService" ;
    ...
    @Override
    public String getId() {
        return AssignmentService.Id;
    }

    @Override
    public void execute(PluginServiceCallbacks callbacks, HttpServletRequest request, HttpServletResponse response) throws Exception {

        log("-> AssignmentService.execute({callbacks : '" + callbacks + "', request: '" + request + "', response: '" + response + "'})");
    ...
    private void doList(PluginServiceCallbacks callbacks, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        log("-> AssignmentService.doList({callbacks : '" + callbacks + "', request: '" + request + "', response: '" + response + "'})");
        ...
        try {
            ...
            String query = "SELECT \n" +
                    "  r.[" + DmConstants.ASSIGNMENT_ID_PROPERTY_NAME + "],\n" +
                    "  r.[" + DmConstants.ASSIGNMENT_TEXT_PROPERTY_NAME + "],\n" +
                    "  r.[" + DmConstants.ASSIGNMENT_DEADLINE_DATE_PROPERTY_NAME + "], \n" +
                    "  r.[" + DmConstants.ASSIGNMENT_MILESTONE_DATE_PROPERTY_NAME + "], \n" +
                    "  r.[" + DmConstants.ASSIGNMENT_STATUS_PROPERTY_NAME + "], \n" +
                    "  e.[" + DmConstants.EMPLOYEE_NAME_PROPERTY_NAME + "] AS \"PerformerName\", \n" +
                    "  c.[" + DmConstants.EMPLOYEE_NAME_PROPERTY_NAME + "] AS \"SupervisorName\" \n" +
                    "FROM \n" +
                    "  ([" + DmConstants.ASSIGNMENT_CLASS_NAME + "] r \n" +
                    "    INNER JOIN [" + DmConstants.EMPLOYEE_CLASS_NAME + "] e ON e.[" + DmConstants.EMPLOYEE_ID_PROPERTY_NAME + "] = r.[" + DmConstants.ASSIGNMENT_PERFORMER_PROPERTY_NAME + "]) \n" +
                    "      LEFT OUTER JOIN [" + DmConstants.EMPLOYEE_CLASS_NAME + "] c ON c.[" + DmConstants.EMPLOYEE_ID_PROPERTY_NAME + "] = r.[" + DmConstants.ASSIGNMENT_SUPERVISOR_PROPERTY_NAME + "]\n" +
                    "WHERE \n" +
                    "  r.[" + DmConstants.ASSIGNMENT_SOURCE_PROPERTY_NAME + "] = '" + id + "'";
            ...
            if (rowSet != null) {
                ...
                while (it.hasNext()) {
                    ...
                    object.put("id", properties.getIdValue(DmConstants.ASSIGNMENT_ID_PROPERTY_NAME).toString());

                    object.put("text", properties.getStringValue(DmConstants.ASSIGNMENT_TEXT_PROPERTY_NAME));

                    Date date = properties.getDateTimeValue(DmConstants.ASSIGNMENT_DEADLINE_DATE_PROPERTY_NAME);
                    ...
                    date = properties.getDateTimeValue(DmConstants.ASSIGNMENT_MILESTONE_DATE_PROPERTY_NAME);
