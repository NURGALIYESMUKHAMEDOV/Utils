...
public class SampleICNTask extends BaseTask {
    ...
    public void performTask() {
        try {
            ...
            String uri = "http://localhost:9080/wsi/FNCEWS40MTOM";//(String)taskInfo.get("http://localhost:9080/wsi/FNCEWS40MTOM");
            String user = "p8admin";
            String pass = "12345Mnbvcxz";//(String)taskInfo.get("12345Mnbvcxz");
            String dom = "p8dom";//(String)taskInfo.get("p8dom");
            String objStoreName = "TOS";//(String)taskInfo.get("TOS");
            ...
            addAuditRecord("SampleICNTask Add", "SampleICNTask Action", "SampleICNTask Status", "SYS->2->URI=>" + uri + ", USER=>" + user + ", PASSWORD=>" + pass + ", DOMAIN=" + dom);
            ...
            System.out.println("SQLstringContract" + SQLstringContract);
            ...
            for (Iterator it = documents.iterator(); it.hasNext(); ) {
                ...
                Date afterOneMonth = null;
                Calendar afterCalendar = new GregorianCalendar();
                afterCalendar.setTime(currentDate);
                afterCalendar.add(Calendar.MONTH, 1);

                afterOneMonth = afterCalendar.getTime();
                ...
                if (taskDate == null)
                    addAuditRecord("SampleICNTask Add", "SampleICNTask Action", "SampleICNTask Status", "taskDate is null");
                else if (taskDate.after(afterOneMonth)) {
